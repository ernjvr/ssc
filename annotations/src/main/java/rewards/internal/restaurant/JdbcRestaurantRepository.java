...
public class JdbcRestaurantRepository implements RestaurantRepository {
    ...
    /**
     * The Restaurant object cache. Cached restaurants are indexed by their
     * merchant numbers.
     */
     ...
     * {@link #restaurantCache restaurant object cache} from rows in the
     * T_RESTAURANT table. Cached restaurants are indexed by their merchant
     * numbers. This method should be called on initialization.
     */
     ...
     * @throws EmptyResultDataAccessException if no restaurant was found with
     * that merchant number
     */
